...
module Glean
  class GleanEventsLogger
    ...
    def _record(
      ...
      identifiers_adjust_device_id:,
      # The user's FxA account ID, if available.
      identifiers_fxa_account_id:,
      # The user's full account handle, with domain. For example, `account_name@mozilla.social`.
      identifiers_mastodon_account_handle:,
      # The user's numeric account ID from Mastodon.
      identifiers_mastodon_account_id:,
      # The device user agent string.
      identifiers_user_agent:,
  ...
  class BackendObjectUpdateEvent
    ...
    def record(
      ...
      @glean._record(
        identifiers_adjust_device_id: identifiers_adjust_device_id,
        identifiers_fxa_account_id: identifiers_fxa_account_id,
        identifiers_mastodon_account_handle: identifiers_mastodon_account_handle,
        identifiers_mastodon_account_id: identifiers_mastodon_account_id,
        identifiers_user_agent: identifiers_user_agent,
        user_agent: user_agent,
        ip_address: ip_address,
        event: event
      )
